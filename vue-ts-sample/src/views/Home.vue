            ...
            >
              ...
              <v-card width="355px">
                <v-container>
                  ...
                  <v-card-actions>
                    <!-- 「:disabled="!itemName || !itemDetail"」で入力値がないとボタンが活性にならないようにしている -->
                    <v-btn
        ...
        >
          ...
          <v-card height="150px">
            <v-container>
              ...
              <v-card-actions>
                <!-- 「:disabled="!cardName"」で入力値がないとボタンが活性にならないようにしている -->
                <v-btn
                  color="green lighten-1"
                  @click="addCard"
                  :disabled="!cardName"
...
export default Vue.extend({
  ...
  // 画面が表示される時、遷移時に実行される処理（ライフタイムサイクル）
  mounted() {
